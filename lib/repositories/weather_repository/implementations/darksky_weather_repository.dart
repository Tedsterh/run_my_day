...
class DarkskyWeatherRepository extends WeatherRepositorty {
  var darksky = new DarkSkyWeather(darkskyApiKey, language: Language.English, units: Units.UK2);
  ...
  @override
  Future<Forecast> getSpecificTimeWeather({DateTime dateTime, LatLng location}) {
    return darksky.getTimeMachineForecast(location.latitude, location.longitude, dateTime);
  }
}
